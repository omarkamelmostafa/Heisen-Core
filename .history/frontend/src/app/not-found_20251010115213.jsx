...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-white flex flex-row items-center justify-center px-4">
      {/* Image from public folder */}
      <div className="mb-8">
        <Image
          src="/images/error-image.png" // Replace with your actual image path
      ...
      {/* 4 4 Text */}
      <p className="text-4xl font-bold text-gray-400 mb-8">4 4</p>
