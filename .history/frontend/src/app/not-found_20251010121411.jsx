  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 relative">
      ...
      <div className="text-center mb-16">
        ...
        <Link
          href="/"
          className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-12 rounded-lg transition-colors duration-200 text-lg"
        >
          Back to home page
        </Link>
      </div>

      {/* 4 4 Text - positioned at bottom left */}
      <div className="absolute bottom-8 left-8">
        <div className="text-6xl font-bold text-gray-300 space-y-0">
          <div>4</div>
          <div>4</div>
        </div>
      </div>

      {/* Footer Text - positioned at bottom right */}
      <div className="absolute bottom-8 right-8 text-right text-gray-500 text-sm space-y-1">
