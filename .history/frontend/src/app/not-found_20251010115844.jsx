  ...
  return (
    <div className="min-h-screen bg-white flex flex-row items-center justify-between px-8">
      ...
      <div className="flex-1 flex flex-col items-start justify-center pl-12">
        {/* Whoops! Heading */}
        <h1 className="text-7xl font-bold text-gray-900 mb-6">Whoops!</h1>
        ...
        <Link
          href="/"
          className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-4 px-10 rounded-lg transition-colors duration-200 text-lg"
        >
          Back to home page
        </Link>

        {/* Error code and footer - positioned at bottom right */}
        <div className="mt-20 flex flex-col items-start">
          {/* 4 4 Text */}
          <p className="text-5xl font-bold text-gray-400 mb-6">4 4</p>
