      ...
      <div className="grid h-full w-full grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex h-full flex-col items-center justify-center px-4 py-8 text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-sm">
            The page you're looking for isn't found, we suggest you go back to
            home.
          </p>
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-primary text-primary-foreground px-6 py-2.5 text-base font-medium shadow-sm transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
          >
            Back to home page
          </Link>
        </div>
        ...
        {/* Right side - Image */}
        <div className="relative flex h-full items-center justify-center p-2 max-lg:hidden">
