  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-8">
      ...
      <div className="flex flex-col items-center text-center max-w-lg">
        {/* Whoops! Heading */}
        <h1 className="text-6xl font-bold text-gray-900 mb-4">Whoops!</h1>
        ...
        <Link
          href="/"
          className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-8 rounded-lg transition-colors duration-200 mb-16"
        >
          Back to home page
        </Link>
      </div>

      {/* Bottom section with error code and footer */}
      <div className="flex flex-col items-center mt-8">
        {/* 4 4 Text */}
        <p className="text-4xl font-bold text-gray-400 mb-6">4 4</p>
