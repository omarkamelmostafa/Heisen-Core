...
export function ProductionErrorTrigger() {
  ...
  // Handle button clicks - errors thrown in event handlers are caught by error boundaries
  ...
  const handleTypeError = () => {
    ...
    nullObject.someMethod(); // This will throw TypeError
  };

  // Render-time error (for testing error boundaries)
  if (errorType === "render") {
    throw new Error("Render-time error for boundary testing");
  }
