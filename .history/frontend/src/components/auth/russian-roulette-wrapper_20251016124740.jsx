...
export function RussianRouletteWrapper({ children }) {
  ...
  if (isDevelopment && rouletteStatus.isSpinning) {
    return (
  ...
  // In production OR when no simulation error in dev: render children
  // REAL errors will be caught by Next.js error.js and show the same ErrorBoundary
  return (
    <>
