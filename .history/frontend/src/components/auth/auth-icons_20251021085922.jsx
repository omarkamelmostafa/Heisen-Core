...
export const AuthIcons = {
  // Layout Icons only (for the titles that had emojis)
  welcome: Hand, // Replaces 👋
  champions: Trophy, // Replaces 🏆
  email: Mail, // Replaces ✉️
  security: Key, // Replaces 🔑
  protection: Shield, // Replaces 🛡️
