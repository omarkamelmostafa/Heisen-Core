// frontend/src/components/ui/fantasy-loader.jsx
"use client";
...
export function FantasyLoader({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-linear-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      >
        ...
        {/* Main Logo Circle */}
        <motion.div
          className="relative h-32 w-32 rounded-full bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-2xl border border-blue-400"
          animate={{
            rotateY: [0, 180, 360],
            boxShadow: [
...
export function SimpleFantasyLoader({ size = "md" }) {
  ...
  return (
    <motion.div
      className={`rounded-full bg-linear-to-br from-blue-500 to-purple-600 ${sizes[size]}`}
      animate={{
        rotate: [0, 180, 360],
        scale: [1, 1.1, 1]
      }}
