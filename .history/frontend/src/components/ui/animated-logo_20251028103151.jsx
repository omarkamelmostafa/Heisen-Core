...
export function AnimatedLogoLoader({
  ...
  return (
    <div
      ref={ref}
      className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50"
    >
        ...
        <AnimatePresence>
          {"Fantasy Coach".split('').map((char, index) => (
            <motion.span
              ...
              className="text-4xl sm:text-5xl font-bold tracking-tight bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 bg-clip-text text-transparent cursor-default"
            >
              {char === ' ' ? '\u00A0' : char}
            </motion.span>
          ))}
