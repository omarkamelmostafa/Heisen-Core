...
//     layout: {
//       login: {
//         title: "Welcome Back Coach! \u{1F44B}", //  👋
//         description:
...
//       },
//       forgotPassword: {
//         title: `Regain Your Access! ${(<KeyRound />)}`,
//         description:
...
// export const useAuthLayoutContent = (page = "login", language = "en") => {
//   return authContent[language]?.layout?.[page] || authContent.en.layout[page];
// };
