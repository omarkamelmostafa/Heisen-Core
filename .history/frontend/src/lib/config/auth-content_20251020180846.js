...
export const authContent = {
  ...
  layout: {
      ...
      signup: {
        ...
        description: "Begin your journey to fantasy greatness today! Create your account to build your ultimate dream team, compete against friends and rivals, and establish your legacy as a master strategist in the world of fantasy sports.",
        cardTitle: "Build Your Legacy",
        cardDescription: "Start your coaching career with full access to premium features, advanced analytics, and everything you need to craft a championship-winning team from day one."
      },
      verifyEmail: {
        title: "Almost Game Time! ✉️",
        description: "The final step before you enter the arena! We've sent a verification link to your inbox - click it to activate your account and unlock the door to unlimited fantasy coaching possibilities and competitive glory.",
        cardTitle: "Verify & Enter The Game",
        cardDescription: "Complete your verification to gain full access to our fantasy coaching ecosystem, including real-time updates, player insights, and strategic tools designed for winners."
      },
      forgotPassword: {
        title: "Regain Your Access! 🔑",
        description: "Every champion faces obstacles - let's get you back in the game swiftly! Enter your email below and we'll immediately send a secure password reset link that will have you back coaching your team in moments, not minutes.",
        cardTitle: "Swift Account Recovery",
        cardDescription: "If our email doesn't appear in your main inbox within a couple of minutes, please check your spam or promotions folder - we want you back in the action as quickly as possible."
      },
      resetPassword: {
        title: "Fortify Your Account! 🛡️",
        description: "Create a powerful new password to secure your Fantasy Coach headquarters. A strong password ensures your strategies, team data, and competitive edge remain protected as you build toward championship success.",
        cardTitle: "Secure Your Coaching Legacy",
        cardDescription: "Choose a robust, memorable password that will safeguard your account, protect your fantasy investments, and keep your winning strategies secure from season to season."
      }
    }
