...
- [x] **E9**: Add i18n framework (e.g., `next-intl`) for multi-language support (EN/ES).
  - *Completed On: 2026-02-20*
Objective:
Make the entire application fully multilingual (English + Spanish) with a scalable translation architecture using `next-intl`.
