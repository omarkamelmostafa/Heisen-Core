...
export const registerValidationRules = [
  ...
  check("confirmPassword")
    ...
    .isLength({ min: 8, max: 128 })
    .withMessage("Confirm password must be between 8 and 128 characters long"),
];
...
export const emailVerificationValidationRules = [
  check("token")
    .isString()
    .withMessage("Verification code must be a string") // Verification is a number not a string 
    .notEmpty()
