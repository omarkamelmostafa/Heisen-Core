...
const disposableDomains = [
  ...
  "maildrop.cc", "tempail.com", "tmpmail.org", "throwawaymail.com",
  "mailnesia.com", "mytrashmail.com", "jetable.org", "mintemail.com",
  "33mail.com", "spamgourmet.com", "grr.la", "mailmetrash.com",
  "deadaddress.com", "banit.club", "mail-temp.com", "tempinbox.com",
  "fake-mail.com", "tempmailo.com", "owleyes.ch", "tempomail.fr",
  "temporarymail.net", "emailondeck.com", "temp-mail.ru", "mail-temporaire.com",
];
  ...
  body(field)
    ...
    .custom((password) => {
      ...
      if (sequential.test(password)) {
        throw new Error("Password contains sequential characters that are easy to guess");
      }
      return true;
    })
    .custom((password) => {
...
export const resetPasswordValidationRules = [
  body("token")
    .notEmpty()
    .withMessage("Reset link token is missing")
    .custom((value) => {
      const str = String(value).trim();
...
export const updatePasswordValidationRules = [
  ...
  body("confirmPassword")
    ...
    .custom((value, { req }) => {
      if (value !== req.body.newPassword) throw new Error("New Passwords must match");
      return true;
    }),
];
