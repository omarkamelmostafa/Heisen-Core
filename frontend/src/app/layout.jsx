  ...
  return (
    <html lang={locale} dir={dir} suppressHydrationWarning>
      ...
      >
        <a
          href="#main-content"
          className="fixed top-4 left-4 z-[100] -translate-y-[200%] focus:translate-y-0 bg-primary text-primary-foreground px-4 py-2 rounded-md font-medium text-sm shadow-lg transition-transform duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
        >
